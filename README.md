...
| Услуги                                 | Форма записи                                     | Инструменты                              |
| -------------------------------------- | ------------------------------------------------ | ---------------------------------------- |
| ![Услуги](screenshots/1-services.jpeg) | ![Форма записи](screenshots/2-contact-form.jpeg) | ![Инструменты](screenshots/3-tools.jpeg) |

| Локальное хранилище                                   | Чек-лист                                  |
| ----------------------------------------------------- | ----------------------------------------- |
| ![Локальное хранилище](screenshots/4-local-save.jpeg) | ![Чек-лист](screenshots/5-checklist.jpeg) |
